...
public class LocalFileTest {
	...
	public void testOpenForReadingAllowsReading() throws IOException {
		...
		LocalFile file = scratch.open("read-allows-read", File.O_RDONLY);
	...
	public void testOpenForReadingDoesntAllowWriting() throws IOException {
		...
		LocalFile file = scratch.open("read-allows-read", File.O_WRONLY);
	...
	public void testOpenForWritingAllowsWriting() throws IOException {
		LocalFile file = scratch.open("write-allows-write", File.O_WRONLY|File.O_CREAT);
	...
	public void testOpenForWritingDoesntAllowReading() throws IOException {
		...
		LocalFile file = scratch.open("write-doesnt-allow-read", File.O_WRONLY);
		file.read();
		file.close();
	}
	...
	public void testOpenForReadWriteAllowsReadWrite() throws IOException {
		...
		LocalFile file = scratch.open("readwrite-allows-readwrite", File.O_RDWR);
	...
	public void testWritingDoesntTruncateFileWithoutOTRUNC() throws IOException {
		...
		LocalFile file = scratch.open("write-without-oappend-truncates", File.O_WRONLY);
		file.close();
		assertEquals(10, scratch.stat("write-without-oappend-truncates").getSize());
	}
	...
	public void testWritingTruncatesFileWithOTRUNC() throws IOException {
		scratch.write("write-without-oappend-truncates", "0123456789".getBytes());
		assertEquals(10, scratch.stat("write-without-oappend-truncates").getSize());
		LocalFile file = scratch.open("write-without-oappend-truncates", File.O_WRONLY|File.O_TRUNC);
		file.close();
	...
	public void testOpeningWithOAPPENDJumpsToEndOfFile() throws IOException {
		...
		LocalFile file = scratch.open("write-with-oappend-jumps-to-end-of-file", File.O_WRONLY|File.O_APPEND);
	...
	public void testOpeningWithoutOAPPENDStartsAtZero() throws IOException {
		...
		LocalFile file = scratch.open("write-without-oappend-jumps-to-end-of-file", File.O_WRONLY);
	...
	public void testOpenFollowsSymlinks() throws IOException {
		...
		LocalFile file = scratch.open("open-follows-symlinks-link", File.O_RDONLY);
	...
	public void testONOFOLLOWDoesNotFollowSymlinks() throws IOException {
		...
		LocalFile file = scratch.open("open-NOFOLLOW-doesnt-follows-symlinks-link", File.O_RDONLY|File.O_NOFOLLOW);
		file.close();
	}
	...
	public void testTruncateShortensFiles() throws IOException {
		...
		LocalFile file = scratch.open("truncate-shortens-files", File.O_RDWR);
	...
	public void testTruncateLengthensWithNullPadding() throws IOException {
		...
		LocalFile file = scratch.open("truncate-lengthens-files", File.O_RDWR);
	...
	public void testTruncateRequiresWriteAccess() throws IOException {
		...
		LocalFile file = scratch.open("truncate-requires-write-access", File.O_RDONLY);
	...
	public void testRead() throws IOException {
		...
		LocalFile file = scratch.open("read", File.O_RDONLY);
		assertTrue(Arrays.equals(text, file.read()));
	}
	...
	public void testWrite() throws IOException {
		...
		LocalFile file = scratch.open("write", File.O_CREAT|File.O_WRONLY);
		file.write(text);
	...
	public void testWriteAtLocation() throws IOException {
		...
		LocalFile file = scratch.open("write-at-location", File.O_CREAT|File.O_WRONLY);
		file.truncate(256);
	...
	public void testSeekSet() throws IOException {
		LocalFile file = scratch.open("seek-set", File.O_CREAT|File.O_WRONLY);
		file.truncate(256);
